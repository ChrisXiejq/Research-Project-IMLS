...
| variant | seed | best_epoch | validation_macro_nll | validation_rollout_macro_top1_ade_m | validation_rollout_macro_top1_fde_m | latency_ms_per_sample |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| B1 | 11 | 20 | 1.86086 | 0.109786 | 0.134755 | 16.7159 |
| B1 | 23 | 20 | 1.86033 | 0.113972 | 0.146284 | 16.9328 |
| B1 | 37 | 20 | 1.86055 | 0.106523 | 0.131462 | 16.3267 |
| B2-D | 11 | 20 | 1.87274 | 0.247519 | 0.448912 | 18.3709 |
| B2-D | 23 | 19 | 1.87284 | 0.25066 | 0.444414 | 17.6443 |
| B2-D | 37 | 20 | 1.87196 | 0.244288 | 0.439565 | 20.1465 |
| B2-M | 11 | 18 | 1.99704 | 0.913933 | 1.62583 | 18.319 |
| B2-M | 23 | 19 | 2.02872 | 1.08818 | 1.72163 | 16.4861 |
| B2-M | 37 | 20 | 2.02553 | 1.05282 | 1.80698 | 18.0465 |
| T1 | 11 | 19 | 2.00296 | 0.944594 | 1.5924 | 18.6889 |
| T1 | 23 | 20 | 2.00883 | 0.952677 | 1.83 | 16.8058 |
| T1 | 37 | 20 | 2.02371 | 1.04626 | 1.72232 | 16.6064 |
| T2 | 11 | 20 | 1.87893 | 0.275639 | 0.472259 | 18.5379 |
| T2 | 23 | 18 | 1.87789 | 0.270532 | 0.470162 | 17.9948 |
| T2 | 37 | 20 | 1.87727 | 0.26816 | 0.455076 | 17.1447 |

## Table 3: table03_frozen_test_and_b0_control.csv

| variant | seed | validation_rank | metric_aggregation | full_horizon_windows | test_rollout_macro_nll | test_rollout_macro_top1_ade_m | test_rollout_macro_top1_fde_m | test_rollouts | test_init_groups |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| B0 pretrained control | n/a | n/a | rollout_macro | 315 | 2.17071 | 1.28267 | 2.64431 | 20 | 5 |
| B1 | 37 | 1 | rollout_macro | 315 | 1.85709 | 0.0996575 | 0.120895 | 20 | 5 |
| B2-D | 11 | 2 | rollout_macro | 315 | 1.87279 | 0.210304 | 0.351423 | 20 | 5 |
| T2 | 23 | 3 | rollout_macro | 315 | 1.87815 | 0.231137 | 0.374208 | 20 | 5 |
| T1 | 23 | 4 | rollout_macro | 315 | 2.00375 | 0.913758 | 1.666 | 20 | 5 |
| B2-M | 37 | 5 | rollout_macro | 315 | 2.02441 | 1.0361 | 1.69488 | 20 | 5 |

## Table 4: table04_calibration_aggregate_vs_response_tail.csv

| variant | subset | samples | rollouts | init_groups | nll_aggregation | uncalibrated_macro_nll | calibrated_macro_nll | uncalibrated_coverage_mae | calibrated_coverage_mae | window_micro_top1_ade_m |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| B0 | all | 315 | 20 | 5 | rollout_macro | 2.17071 | 0.582095 | 0.0553085 | 0.406844 | 1.29879 |
| B0 | response_active | 15 | 6 | 3 | rollout_macro | 2.47177 | 2.95894 | 0.153722 | 0.418167 | 1.7634 |
| B1 | all | 315 | 20 | 5 | rollout_macro | 1.85709 | -2.06857 | 0.114107 | 0.0765783 | 0.105876 |
| B1 | response_active | 15 | 6 | 3 | rollout_macro | 2.07631 | 8.57283 | 0.107478 | 0.442611 | 0.942005 |
