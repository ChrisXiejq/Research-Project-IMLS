...
2. Next CARLA run should test `yield_brake_distance_margin=3.5` and compare against `20260621_200449`.
3. If another min-speed test is needed later, try `0.9`, not `1.0`.
