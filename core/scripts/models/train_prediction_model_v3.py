...
SOURCE_FILES = (
    ...
    SCRIPT_DIR / "evaluate_multipath_model_on_dataset.py",
    SCRIPT_DIR / "multipath_gmm_utils.py",
    SCRIPT_DIR / "prediction_dataset_utils.py",
    SCRIPT_DIR / "prediction_input_contract.py",
)
