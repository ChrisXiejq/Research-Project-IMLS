...
def collection_manifest() -> Dict[str, Any]:
    ...
    return {
        ...
        "fixed_environment": {
            "weather": "ClearNoon",
            "target_vehicle_type": "current frozen give-way vehicle type",
            "target_route": "current frozen give-way target route",
        ...
        "target_style_parameters": {
            ...
            "defensive_reactive": {
                ...
                "parameter_values": "pending Day 5 development freeze using init 01-05 only",
            },
        },
