...
"$python_bin" "$script_dir/experimental/seal_future_mask_v4_pipeline_stage.py" \
...
"$python_bin" "$script_dir/experimental/audit_foundation_future_mask_scope_v4.py" \
  ...
  --legacy-evaluator-source ${LEGACY_DAY8_REPO:-/path/to/Research-Project-IMLS-day8}/core/scripts/models/training/evaluate_multipath_model_on_dataset.py \
...
"$python_bin" "$script_dir/experimental/thesis_core_v3_postprocess.py" stage \
  ...
  --anchors ${LEGACY_DAY8_REPO:-/path/to/Research-Project-IMLS-day8}/core/scripts/models/assets/l5kit_clusters_16.npy \
...
"$python_bin" "$script_dir/experimental/audit_future_mask_v4_offline.py" \
...
"$python_bin" "$script_dir/experimental/plot_future_mask_v4_offline.py" \
...
"$python_bin" "$script_dir/experimental/materialize_future_mask_v4_paper_outputs.py" \
  --root "$mask_root" \
...
"$python_bin" "$script_dir/experimental/seal_future_mask_v4_release.py" \
