...
def clean_checkout_audit(
    ...
    *,
    ...
    try:
        ...
        active_help = [
            [python, "core/scripts/models/experimental/build_r3_paper_synthesis.py", "--help"],
            [python, "core/scripts/models/experimental/build_m1_evidence_package.py", "--help"],
            [python, "core/scripts/models/experimental/build_w1_latex_evidence.py", "--help"],
            [python, "core/scripts/models/experimental/audit_w1_manuscript.py", "--help"],
            [python, "core/scripts/models/experimental/audit_q1_dissertation.py", "--help"],
            [python, "core/scripts/models/tools/build_paper_results_manifest.py", "--help"],
            [python, "core/scripts/models/tools/build_paper_figures.py", "--help"],
            [
                python,
                "core/scripts/models/tools/build_supervisor_feedback_paper_integration.py",
                "--help",
            ],
            [python, "core/scripts/models/tools/audit_paper_evidence_package.py", "--help"],
            [node, "core/scripts/models/experimental/render_w1_r3_figures_png.cjs", "--help"],
        ]
        ...
        stage_specs = [
            (
                [
                    python,
                    "core/scripts/models/experimental/build_r3_paper_synthesis.py",
                    "--repo-root",
                    str(checkout),
                    "--output",
            ...
            (
                [
                    python,
                    "core/scripts/models/experimental/build_m1_evidence_package.py",
                    "--repo-root",
                    str(checkout),
                    "--output",
            ...
            (
                [
                    python,
                    "core/scripts/models/experimental/build_w1_latex_evidence.py",
                    "--repo-root",
                    str(checkout),
                    "--output",
            ...
            (
                [
                    python,
                    "core/scripts/models/tools/build_paper_results_manifest.py",
                    "--repo-root",
                    str(checkout),
                    "--output-dir",
            ...
            (
                [
                    python,
                    "core/scripts/models/tools/build_paper_figures.py",
                    "--repo-root",
                    str(checkout),
                    "--output-dir",
        ...
        png = run(
            [
                node,
                "core/scripts/models/tools/render_paper_figures_png.cjs",
        ...
        commands.append(
            {
                "command": [node, "core/scripts/models/tools/render_paper_figures_png.cjs"],
        ...
        paper_audit = run(
            [
                python,
                "core/scripts/models/tools/audit_paper_evidence_package.py",
                "--repo-root",
                str(checkout),
                "--assets-dir",
                str(paper_root),
        ...
        commands.append(
            {
                "command": [python, "core/scripts/models/tools/audit_paper_evidence_package.py"],
        ...
        w1 = run(
            [
                python,
                "core/scripts/models/experimental/audit_w1_manuscript.py",
        ...
        commands.append(
            {
                "command": [python, "core/scripts/models/experimental/audit_w1_manuscript.py"],
