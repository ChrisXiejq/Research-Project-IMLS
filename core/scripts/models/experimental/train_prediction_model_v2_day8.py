...
TRAINER_RELPATH = "core/scripts/models/experimental/train_prediction_model_v2_day8.py"
ADAPTER_RELPATH = "core/scripts/models/experimental/interaction_adapter_v2.py"
