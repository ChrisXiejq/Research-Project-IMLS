...
B0_OFFLINE_RESULTS="${B0_OFFLINE_RESULTS:-${EXPERIMENT_RESULTS_ROOT:-/path/to/results}/give_way_transformer/day10_gaps/b0_offline_v1}"
...
"${PYTHON_BIN}" "${SCRIPT_DIR}/experimental/summarize_b0_frozen_offline.py" \
...
"${PYTHON_BIN}" "${SCRIPT_DIR}/experimental/package_b0_frozen_offline.py" \
  --results-dir "${B0_OFFLINE_RESULTS}" \
