...
LOSS = "core/scripts/models/interaction_adapter_v2.py"
GMM = "core/scripts/models/multipath_gmm_utils.py"
EVAL = "core/scripts/models/evaluate_multipath_model_on_dataset.py"
DEPLOY = "core/scripts/models/deploy_multipath_model.py"
