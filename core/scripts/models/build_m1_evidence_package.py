...
SF4_REQUIRED_EXECUTION_SOURCES = (
    "core/scripts/carla/run_sf4_supervisor_behavioural_authority_ablation.sh",
    ...
    "core/scripts/models/generate_sf4_supervisor_authority_inits.py",
    "core/scripts/models/preflight_sf4_supervisor_authority_inits.py",
    "core/scripts/models/prepare_sf4_supervisor_behavioural_authority.py",
    "core/scripts/models/verify_day9_deployment.py",
    "core/scripts/models/r3_attempt_manager.py",
    "core/scripts/postcarla_trajectory_gate.py",
    "core/scripts/models/analyze_sf4_supervisor_behavioural_authority.py",
    "core/scripts/models/package_sf4_compact_evidence.py",
    "core/scripts/models/package_sf4_full_raw_snapshot.py",
    "core/scripts/models/validate_sf4_supervisor_authority_smoke.py",
)
    ...
    *,
    ...
    try:
        ...
        expected_sf1_sources = {
            "core/scripts/models/analyze_supervisor_feedback_behaviour.py": (
                repo / "core/scripts/models/analyze_supervisor_feedback_behaviour.py"
            ),
            "core/scripts/models/run_supervisor_feedback_r3_offline_audits.sh": (
                repo / "core/scripts/models/run_supervisor_feedback_r3_offline_audits.sh"
            ),
    ...
    try:
        ...
        expected_combined_sources = {
            "core/scripts/models/analyze_supervisor_feedback_behaviour.py": repo
            / "core/scripts/models/analyze_supervisor_feedback_behaviour.py",
            "core/scripts/models/analyze_supervisor_feedback_cost_feasibility.py": repo
            / "core/scripts/models/analyze_supervisor_feedback_cost_feasibility.py",
            "core/scripts/models/run_supervisor_feedback_r3_offline_audits.sh": repo
            / "core/scripts/models/run_supervisor_feedback_r3_offline_audits.sh",
    ...
    try:
        ...
        checks["current_integration_builder_hash_bound"] = all(
            (
                ...
                == (repo / "core/scripts/models/build_supervisor_feedback_paper_integration.py").resolve(),
