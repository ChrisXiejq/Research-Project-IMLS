...
"$python_bin" "$script_dir/thesis_core_v4e_execute.py" \
...
"$python_bin" "$script_dir/audit_thesis_core_v4e_training.py" \
  --manifest "$manifest" \
...
"$python_bin" "$script_dir/thesis_core_v3_postprocess.py" freeze \
  --manifest "$manifest" \
  --training-root "$mask_root/training" \
...
"$python_bin" "$script_dir/thesis_core_v3_postprocess.py" synthesize \
  --manifest "$manifest" \
  --selection-freeze "$mask_root/postprocess/selection_freeze.json" \
