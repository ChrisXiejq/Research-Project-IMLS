...
CRITICAL_SOURCES = (
    "core/scripts/carla/run_r3_corrected_formal_matrix.sh",
    ...
    "core/scripts/models/audit_r3_corrected_matrix.py",
    "core/scripts/models/analyze_r3_corrected_formal.py",
    "core/scripts/models/r3_attempt_manager.py",
    "core/scripts/models/summarize_r3_progress.py",
    "core/scripts/models/package_closed_loop_snapshot.py",
    "core/scripts/models/capture_r3_execution_provenance.py",
