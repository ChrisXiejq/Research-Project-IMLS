...
def classify_experiment_path(path: str) -> str:
    ...
    if path == "core/scripts/models/build_submission_repository_inventory.py":
        return "new_thesis_work"
    if path == "core/scripts/models/tests/test_build_submission_repository_inventory.py":
        return "new_thesis_work"
    if path.startswith("core/scripts/models/build_supervisor_bottleneck_") and path.endswith(".py"):
        return "new_thesis_work"
    ...
    v3_files = {
        "core/scripts/models/capacity_study_v3_evidence.py",
        "core/scripts/models/generate_capacity_history_v3_results.py",
        "core/scripts/models/generate_integrated_thesis_story.py",
...
def _parse_args() -> argparse.Namespace:
    ...
    default_experiment = Path(__file__).resolve().parents[3]
