...
def analyze_formal(
    ...
    *,
    ...
    offline_runner = (
        analysis_script.parent.parent
        / "experimental"
        / "run_supervisor_feedback_r3_offline_audits.sh"
    )
    source_sha256 = {
        "core/scripts/models/analysis/analyze_supervisor_feedback_behaviour.py": sha256_file(
            analysis_script
        ),
        "core/scripts/models/experimental/run_supervisor_feedback_r3_offline_audits.sh": sha256_file(
            offline_runner
        ),
