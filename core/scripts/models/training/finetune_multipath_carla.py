...
def parse_args():
    ...
    parser.add_argument("--base_model", default=os.path.join(MODELS_DIR, "l5kit_multipath_10"),
                        help="Existing deployed SavedModel directory.")
    parser.add_argument("--anchors", default=os.path.join(MODELS_DIR, "assets", "l5kit_clusters_16.npy"))
    parser.add_argument("--output_model", default=os.path.join(MODELS_DIR, "l5kit_multipath_10_carla_finetuned"))
