...
class VehicleParams:
    ...
    yield_caution_speed : float = 4.5
    yield_creep_speed : float = 1.5
    yield_caution_decel : float = -2.8
    ...
    yield_emergency_decel : float = -6.0
    yield_emergency_jerk_limit : float = 8.0
    yield_emergency_conflict_margin : float = 1.25
    yield_hard_stop_target_distance : float = 8.0
    yield_hard_stop_conflict_distance : float = 7.0
