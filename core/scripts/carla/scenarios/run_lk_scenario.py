...
class RunLKScenario:
    ...
    def run_scenario(self):
        ...
        log.info(
            "LK rollout start savedir=%s max_iters=%s fps=%s policies=%s",
        ...
        try:
            ...
            log.exception("LK scenario failed savedir=%s", os.path.abspath(self.savedir))
            raise
        finally:
