...
RESULTS_DIR="${RESULTS_DIR:-/root/autodl-tmp/results/supervisor_masking_v2/smoke/init116_B1_fixed_medium_assertive}"
...
B1_MODEL="${B1_MODEL:-/root/autodl-tmp/results/capacity_history_thesis_core_v3/training/v3__head-large__lr1e-4__s23__data100/best_model}"
PSTAR_MODEL="${PSTAR_MODEL:-/root/autodl-tmp/results/capacity_history_thesis_core_v3/training/v3__transformer-h1p0-large__lr1e-4__s37__data100/best_model}"
B1_CALIBRATION="${B1_CALIBRATION:-/root/autodl-tmp/results/capacity_history_thesis_core_v3/postprocess/calibration/v3__head-large__lr1e-4__s23__data100/calibration.json}"
PSTAR_CALIBRATION="${PSTAR_CALIBRATION:-/root/autodl-tmp/results/capacity_history_thesis_core_v3/postprocess/calibration/v3__transformer-h1p0-large__lr1e-4__s37__data100/calibration.json}"
