...
PROGRESS_SUMMARIZER="${MODELS_DIR}/experimental/summarize_r3_progress.py"
PROVENANCE_CAPTURE="${MODELS_DIR}/experimental/capture_r3_execution_provenance.py"
R3_ANALYZER="${MODELS_DIR}/experimental/analyze_r3_corrected_formal.py"
SNAPSHOT_PACKAGER="${MODELS_DIR}/tools/package_closed_loop_snapshot.py"
R3_PREFLIGHT_ONLY=0
R3_LIST_PENDING=0
...
"${PYTHON_BIN}" "${MODELS_DIR}/experimental/audit_r3_corrected_matrix.py" \
