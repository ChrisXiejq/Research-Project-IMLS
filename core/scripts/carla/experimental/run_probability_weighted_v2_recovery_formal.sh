...
ANCHORS="${REPO_DIR}/core/scripts/models/assets/l5kit_clusters_16.npy"
...
tracked = {
    ...
    "formal_runner": repo / "core/scripts/carla/experimental/run_probability_weighted_v2_recovery_formal.sh",
    ...
    "anchors": repo / "core/scripts/models/assets/l5kit_clusters_16.npy",
