...
COMPAT_ANALYZER="${MODELS_DIR}/experimental/finalize_sf4_offline_hash_compatibility.py"
...
RECOVERY_PREPARE="${MODELS_DIR}/experimental/prepare_sf4_infrastructure_recovery.py"
