...
PREDICTION_MODEL_ANCHORS="${PREDICTION_MODEL_ANCHORS:-${REPO_DIR}/core/scripts/models/assets/l5kit_clusters_16.npy}"
FROZEN_REDUCED_TUNING_CONFIG="${FROZEN_REDUCED_TUNING_CONFIG:-${SCRIPT_DIR}/scenarios/tuning_configs/give_way_reduced_clear_path_release_v12_current_best.json}"
...
Set PREDICTION_MODEL_WEIGHTS to an absolute model path or place the fine-tuned
model under core/scripts/models/.
EOF
  exit 2
fi
