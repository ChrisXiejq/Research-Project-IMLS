...
SF4_RESULTS="${SF4_RESULTS:-/root/autodl-tmp/results/give_way_transformer/distinction_v1/sf4_supervisor_behavioural_authority_v1}"
...
PREREG_DIR="${PREREG_DIR:-${REPO_DIR}/docs/paper/generated/distinction_sf4_supervisor_authority_ablation/prereg}"
...
PREPARE="${MODELS_DIR}/prepare_sf4_supervisor_behavioural_authority.py"
SPAWN_PREFLIGHTER="${MODELS_DIR}/preflight_sf4_supervisor_authority_inits.py"
...
SMOKE_VALIDATOR="${MODELS_DIR}/validate_sf4_supervisor_authority_smoke.py"
...
"${PYTHON_BIN}" "${MODELS_DIR}/generate_sf4_supervisor_authority_inits.py" \
...
"${PYTHON_BIN}" "${PREPARE}" prepare \
  ...
  --execution-source "${SCRIPT_DIR}/run_sf4_supervisor_behavioural_authority_ablation.sh" \
  ...
  --execution-source "${MODELS_DIR}/generate_sf4_supervisor_authority_inits.py" \
  --execution-source "${SPAWN_PREFLIGHTER}" \
  --execution-source "${PREPARE}" \
  --execution-source "${MODELS_DIR}/verify_day9_deployment.py" \
